...
public class SitiosActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.msperfil:
                ...
                break;
            case R.id.msbares:
                intent = new Intent(SitiosActivity.this, fragmentsActivity.class);
                intent.putExtra("username", username);
                intent.putExtra("correo", correo);
                startActivity(intent);
                finish();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    Sitio1Fragment tab1 = new Sitio1Fragment();
                    return tab1;
                case 1:
                    Sitio2Fragment tab2 = new Sitio2Fragment();
                    return tab2;
                case 2:
                    Sitio3Fragment tab3 = new Sitio3Fragment();
                    return tab3;
                default:
                    return null;
            }
